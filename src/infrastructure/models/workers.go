...
var WorkerWhere = struct {
	...
	Email:     whereHelperstring{field: "`workers`.`email`"},
...
var (
	workerAllColumns            = []string{"worker_id", "email", "name", "status", "created_at", "updated_at"}
	workerColumnsWithoutDefault = []string{"worker_id", "email", "name", "status", "created_at", "updated_at"}
