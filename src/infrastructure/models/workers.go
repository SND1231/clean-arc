...
var WorkerWhere = struct {
	...
	Name:      whereHelpernull_String{field: "`workers`.`name`"},
	Status:    whereHelperint{field: "`workers`.`status`"},
	CreatedAt: whereHelpernull_Time{field: "`workers`.`created_at`"},
	UpdatedAt: whereHelpernull_Time{field: "`workers`.`updated_at`"},
}
