...
var AuthWhere = struct {
	...
	UpdatedAt:           whereHelpernull_Time{field: "`auth`.`updated_at`"},
}
...
var (
	authAllColumns            = []string{"worker_id", "password", "change_password_count", "fail_auth_count", "status", "created_at", "updated_at"}
	authColumnsWithoutDefault = []string{"worker_id", "password", "change_password_count", "fail_auth_count", "status", "created_at", "updated_at"}
