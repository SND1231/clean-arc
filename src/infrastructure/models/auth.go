...
var (
	authAllColumns            = []string{"worker_id", "password", "session", "change_password_count", "fail_auth_count", "created_at", "updated_at"}
	authColumnsWithoutDefault = []string{"worker_id", "password", "session", "change_password_count", "fail_auth_count", "created_at", "updated_at"}
