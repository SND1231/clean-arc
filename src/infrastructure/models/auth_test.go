...
var (
	authDBTypes = map[string]string{`WorkerID`: `varchar`, `Password`: `varchar`, `Session`: `varchar`, `ChangePasswordCount`: `int`, `FailAuthCount`: `int`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_           = bytes.MinRead
)
