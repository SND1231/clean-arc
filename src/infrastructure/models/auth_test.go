...
var (
	authDBTypes = map[string]string{`WorkerID`: `varchar`, `Password`: `varchar`, `ChangePasswordCount`: `int`, `FailAuthCount`: `int`, `Status`: `int`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_           = bytes.MinRead
)
